...
places_data = fetch_kudago_data("places/", params={"page_size": 100})["results"]
events_data = fetch_kudago_data("events/", params={"page_size": 100})["results"]
...
print("Данные собраны: ", len(places_df), "мест и ", len(events_df), "событий.")
